...
contract FastTrackIDO is Ownable, Pausable {
    ...
    function buy(bytes32[] calldata merkleProof, uint256 roseAmount) external payable whenNotPaused returns (bool) {
        ...
        require(
            verifyProof(merkleProof, msg.sender),
